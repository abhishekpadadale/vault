...
import (
	...
	serverseal "github.com/abhishekpadadale/vault/command/server/seal"
	...
	"github.com/abhishekpadadale/vault/sdk/helper/mlock"
...
func (c *ServerCommand) Flags() *FlagSets {
	...
	f.StringVar(&StringVar{
		...
		// See github.com/abhishekpadadale/vault/sdk/helper/logging.ParseEnvLogFormat()
