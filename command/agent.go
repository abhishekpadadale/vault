...
import (
	...
	"github.com/abhishekpadadale/vault/command/agent/auth/alicloud"
	"github.com/abhishekpadadale/vault/command/agent/auth/approle"
	"github.com/abhishekpadadale/vault/command/agent/auth/aws"
	"github.com/abhishekpadadale/vault/command/agent/auth/azure"
	"github.com/abhishekpadadale/vault/command/agent/auth/cert"
	"github.com/abhishekpadadale/vault/command/agent/auth/cf"
	"github.com/abhishekpadadale/vault/command/agent/auth/gcp"
	"github.com/abhishekpadadale/vault/command/agent/auth/jwt"
	"github.com/abhishekpadadale/vault/command/agent/auth/kubernetes"
	"github.com/abhishekpadadale/vault/command/agent/cache"
	"github.com/abhishekpadadale/vault/command/agent/config"
	agentConfig "github.com/abhishekpadadale/vault/command/agent/config"
	"github.com/abhishekpadadale/vault/command/agent/sink"
	"github.com/abhishekpadadale/vault/command/agent/sink/file"
	"github.com/abhishekpadadale/vault/command/agent/sink/inmem"
	"github.com/abhishekpadadale/vault/command/agent/template"
	gatedwriter "github.com/abhishekpadadale/vault/helper/gated-writer"
