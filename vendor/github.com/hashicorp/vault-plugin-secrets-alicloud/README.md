...
This is a backend plugin to be used with [Hashicorp Vault](https://www.github.com/abhishekpadadale/vault).
...
- [Vault Github](https://www.github.com/abhishekpadadale/vault)
...
mkdir $GOPATH/src/github.com/abhishekpadadale/vault-plugin-secrets-alicloud`
cd $GOPATH/src/github.com/hashicorp/
git clone https://github.com/abhishekpadadale/vault-plugin-secrets-alicloud.git

```
(or use `go get github.com/abhishekpadadale/vault-plugin-secrets-alicloud` ).
