...
This is a standalone backend plugin for use with [Hashicorp Vault](https://www.github.com/abhishekpadadale/vault).
...
## Quick Links
    ...
    - Main Project Github: https://www.github.com/abhishekpadadale/vault
...
`$GOPATH/src/github.com/abhishekpadadale/vault-plugin-auth-kubernetes`.
