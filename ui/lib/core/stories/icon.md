...
- [Uses of Icon](https://github.com/abhishekpadadale/vault/search?l=Handlebars&q=Icon+OR+icon)
- [Icon Source Code](https://github.com/abhishekpadadale/vault/blob/master/ui/lib/core/addon/components/icon.js)
