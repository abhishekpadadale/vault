...
- [Uses of MessageError](https://github.com/abhishekpadadale/vault/search?l=Handlebars&q=MessageError)
- [MessageError Source Code](https://github.com/abhishekpadadale/vault/blob/master/ui/app/components/message-error.js)
