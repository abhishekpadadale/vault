...
- [Uses of Confirm](https://github.com/abhishekpadadale/vault/search?l=Handlebars&q=Confirm+OR+confirm)
- [Confirm Source Code](https://github.com/abhishekpadadale/vault/blob/master/ui/lib/core/addon/components/confirm.js)
