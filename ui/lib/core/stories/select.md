...
- [Uses of Select](https://github.com/abhishekpadadale/vault/search?l=Handlebars&q=Select+OR+select)
- [Select Source Code](https://github.com/abhishekpadadale/vault/blob/master/ui/app/components/select.js)
