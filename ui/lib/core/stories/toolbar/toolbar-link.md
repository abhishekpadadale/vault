...
- [Uses of ToolbarLink](https://github.com/abhishekpadadale/vault/search?l=Handlebars&q=ToolbarLink+OR+toolbar-link)
- [ToolbarLink Source Code](https://github.com/abhishekpadadale/vault/blob/master/ui/lib/core/addon/components/toolbar-link.js)
