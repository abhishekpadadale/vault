...
- [Uses of SearchSelect](https://github.com/abhishekpadadale/vault/search?l=Handlebars&q=SearchSelect+OR+search-select)
- [SearchSelect Source Code](https://github.com/abhishekpadadale/vault/blob/master/ui/lib/core/addon/components/search-select.js)
